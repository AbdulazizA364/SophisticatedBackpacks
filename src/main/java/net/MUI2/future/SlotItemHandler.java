...
public class SlotItemHandler extends Slot {
    ...
    private final net.MUI2.future.IItemHandler itemHandler;
    private final int index;

    public SlotItemHandler(net.MUI2.future.IItemHandler itemHandler, int index, int xPosition, int yPosition) {
    ...
    public boolean isItemValid(ItemStack stack) {
        if (stack != null && this.itemHandler.isItemValid(this.index, stack)) {
            net.MUI2.future.IItemHandler handler = this.getItemHandler();
            ItemStack remainder;
