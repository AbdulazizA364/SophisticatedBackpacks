...
public class ItemHandlerHelper {
    ...
    @Nullable
    public static ItemStack insertItem(net.MUI2.future.IItemHandler dest, @Nullable ItemStack stack, boolean simulate) {
    ...
    @Nullable
    public static ItemStack insertItemStacked(net.MUI2.future.IItemHandler inventory, @Nullable ItemStack stack, boolean simulate) {
    ...
    public static void giveItemToPlayer(EntityPlayer player, @Nullable ItemStack stack, int preferredSlot) {
        if (stack != null) {
            net.MUI2.future.IItemHandler inventory = new PlayerMainInvWrapper(player.inventory);
