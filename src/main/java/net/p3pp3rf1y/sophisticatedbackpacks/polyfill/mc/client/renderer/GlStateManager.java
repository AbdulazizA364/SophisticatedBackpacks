package net.p3pp3rf1y.sophisticatedbackpacks.polyfill.mc.client.renderer;
...
public class GlStateManager {
    ...
    public static enum Profile {
        ...
        DEFAULT {
            ...
            public void apply() {
                ...
                GL11.glLightModel(GL11.GL_LIGHT_MODEL_AMBIENT, reflectSetColorBuffer(0.2F, 0.2F, 0.2F, 1.0F));

                for (int i = 0; i < 8; ++i) {
                    GlStateManager.disableLight(i);
                    GL11.glLight(GL11.GL_LIGHT0 + i, GL11.GL_AMBIENT, reflectSetColorBuffer(0.0F, 0.0F, 0.0F, 1.0F));
                    GL11.glLight(GL11.GL_LIGHT0 + i, GL11.GL_POSITION, reflectSetColorBuffer(0.0F, 0.0F, 1.0F, 0.0F));

                    if (i == 0) {
                        GL11.glLight(
                            GL11.GL_LIGHT0 + i,
                            GL11.GL_DIFFUSE,
                            reflectSetColorBuffer(1.0F, 1.0F, 1.0F, 1.0F));
                        GL11.glLight(
                            GL11.GL_LIGHT0 + i,
                            GL11.GL_SPECULAR,
                            reflectSetColorBuffer(1.0F, 1.0F, 1.0F, 1.0F));
                        ...
                        GL11.glLight(
                            GL11.GL_LIGHT0 + i,
                            GL11.GL_DIFFUSE,
                            reflectSetColorBuffer(0.0F, 0.0F, 0.0F, 1.0F));
                        GL11.glLight(
                            GL11.GL_LIGHT0 + i,
                            GL11.GL_SPECULAR,
                            reflectSetColorBuffer(0.0F, 0.0F, 0.0F, 1.0F));
                ...
                GL11.glFog(GL11.GL_FOG_COLOR, reflectSetColorBuffer(0.0F, 0.0F, 0.0F, 0.0F));
                ...
                GlStateManager.texGen(GlStateManager.TexGen.S, 9474, reflectSetColorBuffer(1.0F, 0.0F, 0.0F, 0.0F));
                GlStateManager.texGen(GlStateManager.TexGen.S, 9217, reflectSetColorBuffer(1.0F, 0.0F, 0.0F, 0.0F));
                GlStateManager.disableTexGenCoord(GlStateManager.TexGen.T);
                GlStateManager.texGen(GlStateManager.TexGen.T, 9216);
                GlStateManager.texGen(GlStateManager.TexGen.T, 9474, reflectSetColorBuffer(0.0F, 1.0F, 0.0F, 0.0F));
                GlStateManager.texGen(GlStateManager.TexGen.T, 9217, reflectSetColorBuffer(0.0F, 1.0F, 0.0F, 0.0F));
                GlStateManager.disableTexGenCoord(GlStateManager.TexGen.R);
                GlStateManager.texGen(GlStateManager.TexGen.R, 9216);
                GlStateManager.texGen(GlStateManager.TexGen.R, 9474, reflectSetColorBuffer(0.0F, 0.0F, 0.0F, 0.0F));
                GlStateManager.texGen(GlStateManager.TexGen.R, 9217, reflectSetColorBuffer(0.0F, 0.0F, 0.0F, 0.0F));
                GlStateManager.disableTexGenCoord(GlStateManager.TexGen.Q);
                GlStateManager.texGen(GlStateManager.TexGen.Q, 9216);
                GlStateManager.texGen(GlStateManager.TexGen.Q, 9474, reflectSetColorBuffer(0.0F, 0.0F, 0.0F, 0.0F));
                GlStateManager.texGen(GlStateManager.TexGen.Q, 9217, reflectSetColorBuffer(0.0F, 0.0F, 0.0F, 0.0F));
                ...
                GL11.glTexEnv(
                    ...
                    reflectSetColorBuffer(0.0F, 0.0F, 0.0F, 0.0F));
    ...
    private static FloatBuffer reflectSetColorBuffer(float p_74521_0_, float p_74521_1_, float p_74521_2_,
        float p_74521_3_) {
        FloatBuffer res = null;
        try {
            Method m = RenderHelper.class
                .getDeclaredMethod("setColorBuffer", float.class, float.class, float.class, float.class);
            m.setAccessible(true);
            res = (FloatBuffer) m.invoke(null, p_74521_0_, p_74521_1_, p_74521_2_, p_74521_3_);
